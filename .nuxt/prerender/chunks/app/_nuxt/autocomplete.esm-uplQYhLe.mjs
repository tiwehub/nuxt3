...
import { s as script$5 } from './index.esm-f62AF0Wr.mjs';
import { s as script$6 } from './index.esm-ONukH0xw.mjs';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _ctx.ptm("root")), [!_ctx.multiple ? (openBlock(), createElementBlock("input", mergeProps({
    key: 0,
    ref: "focusInput",
    id: _ctx.inputId,
    type: "text",
...
//# sourceMappingURL=autocomplete.esm-uplQYhLe.mjs.map
