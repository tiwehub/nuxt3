...
import { computed, openBlock, createElementBlock, mergeProps, resolveComponent, resolveDirective, createBlock, withCtx, createVNode, Transition, withDirectives, renderSlot, Fragment, normalizeClass, toDisplayString, createCommentVNode, createElementVNode, resolveDynamicComponent, createTextVNode } from 'file://D:/OSPanel/home/profiline/node_modules/vue/index.mjs';
import { s as script$4 } from './portal.esm-GQNjR_5n.mjs';
import { B as BaseStyle, U as UniqueComponentId, Z as ZIndexUtils, D as DomHandler, R as Ripple } from '../server.mjs';
  ...
  methods: {
    ...
    initDrag: function initDrag(event) {
      ...
      if (this.draggable) {
        ...
        (void 0).body.setAttribute("data-p-unselectable-text");
...
//# sourceMappingURL=dialog.esm-Qg3KRtaM.mjs.map
